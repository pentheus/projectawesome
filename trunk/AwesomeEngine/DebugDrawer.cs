...
namespace AwesomeEngine
{
    public class DebugDrawer : DrawableGameComponent
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            ContainsScene playGround = this.Game as ContainsScene;

            this.basicEffect.AmbientLightColor = Vector3.One;
            this.basicEffect.View = playGround.GetCamera().View;
            this.basicEffect.Projection = playGround.GetCamera().Projection;
        ...
        public void DrawShape(List<VertexPositionColor> shape)
        {
            ...
            {
                Vector3 v = vertexData[vertexData.Count - 1].Position;
                vertexData.Add(new VertexPositionColor(v, new Color(1, 1, 1, 1)));
                vertexData.Add(new VertexPositionColor(shape[0].Position, new Color(1, 1, 1, 1)));
            }
